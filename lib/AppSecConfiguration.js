...
/*
 */
module.exports.cloneConfigVersion = function (configId, versionId, callback) {
    var data = {
        "configId": configId,
        "version": versionId,
        "versionNotes": "cloning"
    };
    var path = base + 'configs/' + configId + '/versions/' + versionId + '/';
...
/*
 */
module.exports.policies = function (configId, versionId, callback) {
    var path = base + 'configs/' + configId + '/versions/' + versionId + '/policies';
    EdgeGrid.get( path, callback ).end();
};

/*
 */
module.exports.match_target_order = function (configId, versionId, callback) {
    var path = base + 'configs/' + configId + '/versions/' + versionId + '/policies';
    EdgeGrid.get( path, callback ).end();
};
...
/*
 */
module.exports.create_match_target = function (configId, versionId, callback) {
    var path = base + 'configs/' + configId + '/versions/' + versionId + '/policies';
    EdgeGrid.get( path, callback ).end();
};
...
/*
 */
module.exports.modify_match_target = function (configId, versionId, callback) {
    var path = base + 'configs/' + configId + '/versions/' + versionId + '/policies';
    EdgeGrid.get( path, callback ).end();
};
 ...
 */
module.exports.activate = function (options, callback) {
 ...
 */
module.exports.activation = function (configId, versionId, activationId, callback) {
    var path = base + 'configs/' + configId + '/versions/' + versionId;
    EdgeGrid.get( path, callback ).end();
};
